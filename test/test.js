...
describe("html2md", function() {
	it("should be able to convert '<h1>H1</h1>' to '# H1'", function() {
		var md = html2md("<h1>H1</h1>");
		expect(md).to.equal("# H1");
	});

	it("should be able to convert '<h2>H2</h2>' to '## H2'", function() {
		var md = html2md("<h2>H2</h2>");
		expect(md).to.equal("## H2");
	});

	it("should be able to convert '<h3>H3</h3>' to '### H3'", function() {
		var md = html2md("<h3>H3</h3>");
		expect(md).to.equal("### H3");
	});

	it("should be able to convert '<h4>H4</h4>' to '#### H4'", function() {
		var md = html2md("<h4>H4</h4>");
		expect(md).to.equal("#### H4");
	});

	it("should be able to convert '<h5>H5</h5>' to '##### H5'", function() {
		var md = html2md("<h5>H5</h5>");
		expect(md).to.equal("##### H5");
	});

	it("should be able to convert '<h6>H6</h6>' to '###### H6'", function() {
		var md = html2md("<h6>H6</h6>");
		expect(md).to.equal("###### H6");
	});

	it("should be able to convert '<strong>Bold</strong>' to '**Bold**'", function() {
		var md = html2md("<strong>Bold</strong>");
		expect(md).to.equal("**Bold**");
	});

	it("should be able to convert '<b>Bold</b>' to '**Bold**'", function() {
		var md = html2md("<b>Bold</b>");
		expect(md).to.equal("**Bold**");
	});

	it("should be able to convert '<em>Italic</em>' to '_Italic_'", function() {
		var md = html2md("<em>Italic</em>");
		expect(md).to.equal("_Italic_");
	});

	it("should be able to convert '<i>Italic</i>' to '_Italic_'", function() {
		var md = html2md("<i>Italic</i>");
		expect(md).to.equal("_Italic_");
	});

	it("should be able trim text inside inline elements", function() {
		var md = html2md("<strong> String </strong>");
		expect(md).to.equal("**String**");
	});

	it("should be able to convert 'This has a <strong>block</strong> word' to 'This has a **block** word'", function() {
		var md = html2md("This has a <strong>block</strong> word");
		expect(md).to.equal("This has a **block** word");
	});

	it("should be able to convert '<hr />' to '- - -'", function() {
		var md = html2md("<hr />");
		expect(md).to.equal("- - -");
	});
	...
	it("should be able to convert 'This has <strong>blocked and <em>italicized</em></strong> texts.' to 'This has **blocked and _italicized_** texts.'", function() {
		var md = html2md("This has <strong>blocked and <em>italicized</em></strong> texts.");
		expect(md).to.equal("This has **blocked and _italicized_** texts.");
	});
	...
	it("should be able to convert 'this is text before hr<hr/>this is text after hr' to 'this is text before hr\\n\\n- - -\\n\\nthis is text after hr'", function() {
		var md = html2md("this is text before hr<hr/>this is text after hr");
		expect(md).to.equal("this is text before hr\n\n- - -\n\nthis is text after hr");
	});
	...
	it("should be able to convert 'this is text before break<br/>this is text after break' to 'this is text before break  \\nthis is text after break'", function() {
		var md = html2md("this is text before break<br/>this is text after break");
		expect(md).to.equal("this is text before break  \nthis is text after break");
	});

	it("should be able to convert '<p>This is a paragraph. This is the second sentence.</p>' to 'This is a paragraph. This is the second sentence.'", function() {
		var md = html2md("<p>This is a paragraph. This is the second sentence.</p>");
		expect(md).to.equal("This is a paragraph. This is the second sentence.");
	});
	...
	it("should be able to convert 'this is text before paragraph<p>This is a paragraph</p>this is text after paragraph' to 'this is text before paragraph\\n\\nThis is a paragraph\\n\\nthis is text after paragraph'", function() {
		var md = html2md("this is text before paragraph<p>This is a paragraph</p>this is text after paragraph");
		expect(md).to.equal("this is text before paragraph\n\nThis is a paragraph\n\nthis is text after paragraph");
	});

	it("should be able to convert span element", function() {
		var md = html2md("<span>this is span element</span>");
		expect(md).to.equal("this is span element");

		md = html2md("before<span>this is span element</span>after");
		expect(md).to.equal("beforethis is span elementafter");

		md = html2md("before <span>this is span element</span> after");
		expect(md).to.equal("before this is span element after");
	});

	it("should be able to convert '<blockquote>This is blockquoted</blockquote>' to '> This is blockquoted'", function() {
		var md = html2md("<blockquote>This is blockquoted</blockquote>");
		expect(md).to.equal("> This is blockquoted");
	});

	it.skip("should be able to convert nested blockquotes", function() {
...
//	it.skip("should be able to convert a block of html", function() {
...
//	});
	...
	it.skip("should be able to convert images inline style", function() {
	...
	it.skip("should be able to convert images reference style", function() {
	...
	it.skip("should be able to convert images as block elements", function() {
	...
	it.skip("should not convert images if url is empty", function() {
		var md = markdown("<img alt=\"Example Image\" title=\"Free example image\">");
		expect(md).toEqual("");
	});

	it.skip("should be able to properly convert links reference style", function() {
	...
	it.skip("should be able to convert links inline style", function() {
	...
	it.skip("should not convert if link has no text to display", function() {
		var html = "<a href='/'/>";
		md = markdown(html);
		expect(md).toEqual("");
	...
	it.skip("should convert elements with child elements surrounded by whitespace", function() {
	...
	it.skip("should convert image wrapped in anchor to markdown that can be rendered using showdown - inline style parsing", function() {
	...
	it.skip("should convert image wrapped in anchor to markdown that can be rendered using showdown - reference style parsing", function() {
	...
	it.skip("should output only text of empty links", function() {
	...
	it.skip("should not convert any elements that have no parsing rules. ", function() {
	...
	//tables
	it.skip("should be able to convert tables", function() {
	...
	it.skip("should be able to convert tables with lists", function() {
		var html = "<table border=\"1\">";
	...
	it.skip("should not convert emptyt tags", function() {
	...
	it.skip("should collape whitespace to single space for text nodes", function() {
	...
	it.skip("should trim anchor title and text", function() {
		var md = markdown("<a href=\"http://www.example.com\" title=\"   Example   \">   Visit Example    </a>", {"inlineStyle": true});
		expect(md).toEqual("[Visit Example](http://www.example.com \"Example\")");
	...
	it.skip("should trim image alt and title", function() {
	...
	it.skip("should be able to convert image followed by link to markdown that can be renderd using showdown", function() {
		var html = "<p>\n";
	...
	it.skip("should be able to convert list items with linked images as only linked images", function() {
	...
	it.skip("should be able to convert title", function() {
		var html = "<hgroup>\n";
	...
	it.skip("should be able to convert paragrphs in blocquotes", function() {
		var html="<blockquote>\n";
	...
	it.skip("should be able to convert pre block", function() {
		var html = "<pre>";
	...
	it.skip("should be able to convert pre block with html tags", function() {
		var html = "<pre>\n";
		html += "<div a=\"b\">\n";
	...
	it.skip("should be able to convert <pre><code>...</code></pre> blocks", function() {
